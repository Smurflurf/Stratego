...
class MoveTest {
	...
	void getRelevantFields() {
		Move move1 = new Move(new Piece(PieceType.MARSCHALL, true, 4, 4), Direction.UP, 1);
		...
		Move move2 = new Move(new Piece(PieceType.SPAEHER, true, 4, 4), Direction.UP, 4);
		...
		Move move3 = new Move(new Piece(PieceType.SPAEHER, true, 4, 4), Direction.RIGHT, 3);
		...
		Move move4 = new Move(new Piece(PieceType.MINEUR, false, 7, 0), Direction.LEFT, 1);
